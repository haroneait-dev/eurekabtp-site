import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */import{s as i,P as r}from"./supabase-client-BqP9cGay.js";import"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2/+esm";function o(t){return String(t??"").replace(/[&<>"']/g,a=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[a])}function d(t){const a=[t.titre,t.description,t.tag,t.in_stock?"":"rupture stock indisponible",t.is_promo?"promo promotion soldes":""].filter(Boolean).join(" ").toLowerCase(),s=t.tag||"Pièce",e=!t.in_stock,c=e?'<span class="catalog-stock-badge catalog-stock-badge--out">Rupture de stock</span>':'<span class="catalog-stock-badge catalog-stock-badge--in">En stock</span>',n=t.is_promo?'<span class="catalog-promo-badge">Promo</span>':"";return`
